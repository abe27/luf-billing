                ...
                >
                  {profile ? (
                    <ul
                      ...
                      onMouseLeave={() => setProfile(false)}
                    >
                      <li onClick={logout} className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
